...
export default function AboutPage() {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[calc(100svh-4rem)] p-4 md:p-12">
      <motion.div
        variants={container}
        initial="hidden"
        animate="show"
      ...
      >
        {/* Header Section */}
        <motion.div variants={item} className="flex flex-col items-center text-center space-y-4 md:space-y-6">
          <div className="relative group cursor-default">
            ...
            <div className="relative transform transition-transform duration-500 hover:scale-105 hover:rotate-3">
              <Logo size={64} className="md:!size-20" />
            </div>
          </div>
        ...
        <motion.div variants={item} className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
          {/* Developer Card */}
          <div className="group relative overflow-hidden rounded-2xl md:rounded-3xl border bg-card/50 hover:bg-card/80 transition-colors p-5 md:p-8">
